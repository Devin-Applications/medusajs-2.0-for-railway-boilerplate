      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex relative w-full">
          <textarea
            ...
            required={required}
            rows={rows}
            className="block w-full px-4 py-2 bg-gray-50 border rounded-md appearance-none focus:outline-none focus:ring-0 focus:border-grey-90 border-grey-40 hover:border-grey-60 shadow-sm transition-colors resize-none"
            maxLength={500}
            {...props}
            ref={textareaRef}
          />
