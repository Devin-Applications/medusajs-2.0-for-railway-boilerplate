      ...
      <div className="flex flex-col w-full">
        ...
        <div className="flex relative w-full">
          <textarea
            ...
            required={required}
            rows={rows}
            className="block w-full px-4 py-2 bg-gray-100 border-2 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-500 border-orange-200 hover:border-orange-400 shadow-lg transition-all placeholder-gray-500 resize-none"
            maxLength={500}
            {...props}
            ref={textareaRef}
          />
