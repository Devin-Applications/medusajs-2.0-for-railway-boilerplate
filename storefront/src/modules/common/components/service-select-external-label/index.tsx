    ...
    <div className="flex flex-col w-full">
      ...
      <div className="flex relative w-full">
        <select
          ...
          id={name}
          required={required}
          className={`${className} block w-full max-w-xs h-10 px-4 py-2 bg-gray-300 border-2 border-gray-500 rounded-lg appearance-none focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-500 hover:border-orange-400 shadow-inner shadow-gray-400/50 transition-all placeholder-gray-500`}
          {...props}
        >
